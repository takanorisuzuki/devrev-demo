...
**📁 [architecture/](../architecture/)** - アーキテクチャ・設計ドキュメント

設計関連のドキュメントは全て `docs/architecture/` に移動しました。詳細は [architecture/README.md](../architecture/README.md) を参照してください。
...
2. **[workflows/](./driverev-lab/workflows/)** - DevRev Workflow テンプレート
   - `get-api-key.json` - API Key 取得 Workflow
   - `get-user-info.json` - ユーザー情報取得
   - `book-reservation.json` - 予約作成
   - 使い方は [workflows/README.md](./driverev-lab/workflows/README.md) を参照
...
1. [ラボガイド](./driverev-lab/README.md) - ハンズオンラボガイド
   - **所要時間**: 2-3 時間
   - **前提知識**: なし
...
1. [アーキテクチャ概要](../architecture/overview.md) - アーキテクチャ比較
2. [機能比較分析](../architecture/feature-comparison.md) - 機能比較
3. [実装分析](../architecture/implementation-analysis.md) - 実装分析
   - **所要時間**: 1-2 時間
   - **前提知識**: Web 開発の基礎
   - **成果**: システム全体の設計思想を理解
...
1. **[実装分析](../architecture/implementation-analysis.md) - 最初に必読** ⭐
...
2. [実装計画](../architecture/implementation-plan.md) - 実装計画
   - 12 週間のロードマップ、工数見積もり
3. [アーキテクチャ概要](../architecture/overview.md) + [機能比較分析](../architecture/feature-comparison.md)
   - 設計レビュー用
   - **所要時間**: 2-3 時間
   - **前提知識**: システム設計の経験
   - **成果**: Phase 0 計画承認ができる
...
**詳細なトラブルシューティング**: [ラボガイド - トラブルシューティング](./driverev-lab/README.md) を参照
