...
class StoreUpdate(BaseModel):
    ...
    code: Optional[str] = Field(None, min_length=3, max_length=10, description="店舗コード")
    prefecture: Optional[str] = Field(None, min_length=2, max_length=10, description="都道府県")
    city: Optional[str] = Field(None, min_length=1, max_length=50, description="市区町村")
    address_line1: Optional[str] = Field(None, min_length=1, max_length=200, description="住所1")
    address_line2: Optional[str] = Field(None, max_length=200, description="住所2")
    postal_code: Optional[str] = Field(None, max_length=8, description="郵便番号")
    phone: Optional[str] = Field(None, max_length=20, description="電話番号")
    email: Optional[str] = Field(None, max_length=100, description="メールアドレス")
