...
from app.api.v1 import auth, vehicles, stores, reservations, admin_users, admin_reservations, admin_stats, admin_stores, payments, system_settings
...
# 管理者機能
api_router.include_router(admin_users.router, prefix="/admin/users", tags=["管理者ユーザー管理"])
api_router.include_router(admin_reservations.router, prefix="/admin/reservations", tags=["管理者予約管理"])
api_router.include_router(admin_stats.router, prefix="/admin", tags=["管理者統計"])
api_router.include_router(admin_stores.router, prefix="/admin/stores", tags=["管理者店舗管理"])
